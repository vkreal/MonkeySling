(function () {
    ...
    string = require("color-string");
      ...
      to = pair[2];
        ...
        module.exports = {
            ...
            cssKeywords2List: cssKeywords2List
        }
    ...
    : b = (b * 12.92);
      ...
      x, y, z, y2;
        ...
        function cssKeywords2List() {
            return cssKeywordsList;
        }
...
//            whitesmoke: [245, 245, 245],
        ...
        for (var key in cssKeywords) {
            ...
            cssKeywordsList.push({
                name: key,
                color: cssKeywords[key]
            });
        }
    });
    Color = require('color.js');
    Color.conversions = require("conversions");
