...
var Box2D = {};
(function () { 
    // HACK TO FIX http://code.google.com/p/box2dweb/issues/detail?id=29
...
(function () {
   ...
   b2DynamicTree.prototype.Query2 = function (callback, aabb) {
      if (this.m_root == null) return;
      ...
      while (count > 0) {
         ...
         if (node.aabb.TestOverlap(aabb)) {
            if (node.IsLeaf()) {
                if( node.userData && node.userData.GetBody().GetUserData()) {
                    overlap.push(node.userData);
                }
            }
            else {
   ...
   b2DynamicTreeBroadPhase.prototype.Query2 = function (callback, aabb) {
      this.m_tree.Query2(callback, aabb);
   }
...
(function () {
   ...
   b2World.prototype.QueryAABB2 = function (callback, aabb) {
      var __this = this;
      var broadPhase = __this.m_contactManager.m_broadPhase;

      function WorldQueryWrapper(list) {
         return callback(list);
      };
      broadPhase.Query2(WorldQueryWrapper, aabb);
   }
